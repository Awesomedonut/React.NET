...
* Check the `ConnectionStrings` in `appsettings.json` files under the `MyAbpApp.Web` and `MyAbpApp.DbMigrator` projects and change it if you need.
...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0a4bf778-610b-433f-b93a-ee82a69d6797
```

> `0a4bf778-610b-433f-b93a-ee82a69d6797` is the password of the certificate, you can change it to any password you want.
...
* `MyAbpApp.Web`: ASP.NET Core MVC / Razor Pages application that is the essential web application of the solution.
